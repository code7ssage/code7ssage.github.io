...
- 목표: Bias는 유지하면서 Variance를 낮춤
	• Tree는 작은 Bias와 큰 Variance를 갖기 때문에, 매우 깊이 성장한(Depth가 깊은) 트리는 훈련 데이터에 대해 [Overfitting](https://code7ssage.github.io/key_terms/Overfitting/) 하게 됨 
...
- 실습: [7. Random Forest Code](https://code7ssage.github.io/code_file/7.-Random-Forest-Code/)