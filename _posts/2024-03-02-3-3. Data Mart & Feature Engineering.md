...
* [Regression](https://code7ssage.github.io/regression//)(회귀) : 상관계수 분석을 통해 유의미한 변수 선택 
* [Classification](https://code7ssage.github.io/classification//)(분류) : bin(통)으로 구분 후 Target 변수와의 관계 파악
